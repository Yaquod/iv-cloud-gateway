...
void VechileGatewayClient::SendEta(const std::string &vin_number_val,
                                   const std::string &trip_id_val,
  ...
  if (status.ok()) {
    ...
    spdlog::error("RPC send status failed in sendeta: {}",
                  status.error_message());
  }
}

void VechileGatewayClient::SendStatus(const std::string &vin_number_val,
                                      const std::string &trip_id_val,
...
void VechileGatewayClient::SendArrive(const std::string &vin_number_val,
                                      const std::string &trip_id_val,
