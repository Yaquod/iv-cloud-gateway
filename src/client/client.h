...
class VechileGatewayClient {
 public:
  ...
  bool SendEta(const std::string &vin_number_val, int64_t request_id_val,
               double time_val, double fare_val);
  bool SendStatus(const std::string &vin_number_val, int64_t trip_id_val,
                  const std::string &status_val);
  bool SendArrive(const std::string &vin_number_val, int64_t trip_id_val,
                  double long_val, double lat_val);
  bool UpdateLocation(const std::string &vin_number_val, double long_val,
                      double lat_val);
 ...
 private:
  ...
  struct UpdateVehicleLocationCallData : AsyncCallDataBase {
    vehicle_gateway::UpdateVehicleLocationResponse response;
  ...
  struct EtaCallData : AsyncCallDataBase {
    ...
    std::unique_ptr<
        grpc::ClientAsyncResponseReader<vehicle_gateway::EtaResponse>>
        response_reader;
  };
  ...
  struct StatusCallData : AsyncCallDataBase {
    ...
    std::unique_ptr<
        grpc::ClientAsyncResponseReader<vehicle_gateway::StatusResponse>>
        response_reader;
  };
  ...
  struct ArriveCallData : AsyncCallDataBase {
    ...
    std::unique_ptr<
        grpc::ClientAsyncResponseReader<vehicle_gateway::ArriveResponse>>
        response_reader;
  };
};
